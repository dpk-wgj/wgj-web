...
import com.dpk.wgj.bean.SocketMessage;
import com.dpk.wgj.bean.TeacherWebSocketSession;
...
public class TeacherWebSocket extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        try {
            UserDTO userInfo = jwtTokenUtil.verifyToken((String) session.getAttributes().get("token"));
            if (userInfo != null) {
